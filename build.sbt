...
libraryDependencies ++= Seq(
	...
	"com.galacticfog" %% "gestalt-meta-repository" 	% "0.2.0-SNAPSHOT" withSources(),
	"com.galacticfog" %% "gestalt-meta-sdk-scala" % "0.3.1-SNAPSHOT" withSources(),
	"com.galacticfog" %% "gestalt-security-play" 	% "2.2.1-SNAPSHOT" withSources()
)
