  ...
  /*
 * TODO: This attaches validation to numeric form-inputs. This can
 * be generalized
 */
 ...
 */
  ...
  /**
 * Display the colored header at the top of the window with the
 * given title
 */
 ...
 */
  ...
  /**
 * Determine if the given form-field should be serialized to the
 * response payload. The implementation will currently exclude any
 * form element without an .id or .value - this means that empty
 * form elements will be excluded. If you want empty elements you'll
 ...
 */
  ...
  /**
 * Convert 'gestalt-action-form' fields to JSON using `input.id` as
 * the keys.
 */  
