...
/*
 * 
 * [NOTE]: This whole spec needs to be looked at. It goes off the rails right at the beginning because the first
 * two examples are testing the *wrong component*.  /{fqon}/resourcetypes is (and always was) handled by
 * TypeController - not ResourceController (the subject of this specification).  
 * 
 */
