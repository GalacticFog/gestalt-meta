 ...
 */
abstract class LambdaProvider[+C,R,L](client: C) {
  def lambdas(): Seq[L]
...
class FakeLambdaProvider(client: JsonWebClient) 
    extends LambdaProvider[JsonWebClient,ApiResponse,LaserLambda](client) {
...
class LambdaProviderImpl(client: JsonWebClient) 
    extends LambdaProvider[JsonWebClient,ApiResponse,LaserLambda](client) {
