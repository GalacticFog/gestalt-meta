...
//      providerManager.getProvider(meq(testProvider), any, any) returns Success(Some(mockActionProvider))
//      t
//    }
//  }
//
...
//      there was atLeastOne(providerManager).getProvider(testProvider, "blueprint.create", callerAuth = "fakeCreds")
...
//
//      val invocationCaptor = ArgumentCaptor.forClass(classOf[GenericActionInvocation])
//      there was atLeastOne(providerManager).getProvider(testProvider, "blueprint.import", callerAuth = "fakeCreds")
//      there was one(mockActionProvider).invokeAction(invocationCaptor.capture())
//      val invocation = invocationCaptor.getValue
...
//
//      val invocationCaptor = ArgumentCaptor.forClass(classOf[GenericActionInvocation])
//      there was atLeastOne(providerManager).getProvider(testProvider, "blueprint.deploy", callerAuth = "fakeCreds")
//      there was one(mockActionProvider).invokeAction(invocationCaptor.capture())
//      val invocation = invocationCaptor.getValue
...
//
//      val invocationCaptor = ArgumentCaptor.forClass(classOf[GenericActionInvocation])
//      there was atLeastOne(providerManager).getProvider(testProvider, "blueprint.delete", callerAuth = "fakeCreds")
//      there was one(mockActionProvider).invokeAction(invocationCaptor.capture())
//      val invocation = invocationCaptor.getValue
...
//
//      val invocationCaptor = ArgumentCaptor.forClass(classOf[GenericActionInvocation])
//      there was atLeastOne(providerManager).getProvider(testProvider, "blueprint.update", callerAuth = "fakeCreds")
//      there was one(mockActionProvider).invokeAction(invocationCaptor.capture())
//      val invocation = invocationCaptor.getValue
